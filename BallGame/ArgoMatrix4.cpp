...
ArgoMatrix4 &ArgoMatrix4::setAsModelViewProjection()
{
	ArgoMatrix4 modelView;
	ArgoMatrix4 projection;
...
ArgoMatrix4 &ArgoMatrix4::setAsModelViewMatrix()
{
	float curMV[16];
	glGetFloatv(GL_MODELVIEW_MATRIX, curMV); 
	ArgoMatrix4 modelView(curMV);
	*this=modelView;
	return *this;
}

ArgoMatrix4 &ArgoMatrix4::setAsProjectionMatrix()
{
	float curProj[16];
	glGetFloatv(GL_PROJECTION_MATRIX, curProj); 
	ArgoMatrix4 proj(curProj);
	*this=proj;
	return *this;
}